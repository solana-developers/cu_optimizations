...
use solana_program_compute_optimizations_client::{accounts::Counter, instructions::CreateBuilder};
...
async fn create() {
    let mut context = ProgramTest::new(
        "solana_program_compute_optimizations",
        solana_program_compute_optimizations_client::ID,
        None,
    )
    .start_with_context()
    .await;
